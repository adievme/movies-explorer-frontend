    ...
    <section className='portfolio'>
      <div className='portfolio__content'>
        ...
        <ul className='portfolio__list-projects'>
          <a className='portfolio__link-project' href='https://github.com/adievme/how-to-learn'>
            <li className='portfolio__item-project'>Статичный сайт</li>
            <img className='portfolio__icon-link' src={icon} alt='icon'/>
          </a>
          <a className='portfolio__link-project' href='https://github.com/adievme/russian-travel'>
            <li className='portfolio__item-project'>Адаптивный сайт</li>
            <img className='portfolio__icon-link' src={icon} alt='icon'/>
          </a>
          <a className='portfolio__link-project' href='https://github.com/adievme/react-mesto-api-full'>
